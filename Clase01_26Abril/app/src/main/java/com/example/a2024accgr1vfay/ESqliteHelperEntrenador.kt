...
class ESqliteHelperEntrenador (
    ...
    fun actualizarEntrenadorFormulario(
        ...
        val resultadoActualizacion = conexionEscritura
            .update(
                "ENTRENADOR",
                valoresAActualizar, // nombre=Anthony, descripcion=B
                "id=?", // id=1
    ...
    fun consultarEntrenadorPorID(id:Int):BEntrenador?{
        ...
        if(existeAlMenosUno){
            do{
                val entrenador = BEntrenador( // Debe ser acorde al script de consulta creado en esta fun.
